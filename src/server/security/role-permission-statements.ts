...
export const ROLE_PERMISSION_STATEMENTS: Record<string, readonly string[]> = {
    ...
    'hr.onboarding.checklist': ['read', 'list', 'update', 'complete'],
    ...
    'hr.policy.acknowledgment': ['read', 'list', 'acknowledge'],
    'hr.onboarding.feedback': ['read', 'list'],
    'hr.onboarding.email-sequence.template': ['read', 'list', 'create', 'update'],
    'hr.onboarding.workflow.template': ['read', 'list', 'create', 'update'],
    'hr.onboarding.metric.definition': ['read', 'list', 'create', 'update'],
