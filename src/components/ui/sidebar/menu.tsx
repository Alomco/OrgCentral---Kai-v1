...
export function SidebarMenuAction({
    ...
    return (
        <Comp
            ...
            className={cn(
                "text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:shadow-[0_0_0_1px_oklch(var(--sidebar-ring)/0.45),0_0_0_4px_oklch(var(--sidebar-ring)/0.2)] [&>svg]:size-4 [&>svg]:shrink-0",
