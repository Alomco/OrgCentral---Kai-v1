...
const RESOURCE_ALIAS_MAP: Record<string, readonly string[]> = {
    ...
    'hr.onboarding.feedback': ['hrOnboarding'],
    'hr.onboarding.email-sequence.template': ['hrOnboarding'],
    'hr.onboarding.workflow.template': ['hrOnboarding'],
    'hr.onboarding.metric.definition': ['hrOnboarding'],
