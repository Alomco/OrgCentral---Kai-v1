...
export function ModalOverlay({
  ...
  return (
    <Dialog.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-(--z-overlay) bg-[hsl(var(--background)/0.85)] backdrop-blur-md backdrop-saturate-75",
        className
      )}
      {...props}
    />
  ...
  return (
    <ModalPortal>
      ...
      <Dialog.Content
        ...
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-(--z-modal) flex min-h-0 max-h-[calc(90vh-2rem)] flex-col overflow-hidden bg-[hsl(var(--popover))] border border-[hsl(var(--border)/var(--ui-border-opacity))] p-0 shadow-(--ui-card-shadow) transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--primary)/0.4)] focus-visible:ring-offset-2 focus-visible:ring-offset-background",
          side === "center" &&
          cn(
