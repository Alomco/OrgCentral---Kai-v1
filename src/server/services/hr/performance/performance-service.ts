...
import {
    ...
    handleUpdateReview,
    type ServiceContext,
} from './performance-service.handlers';
import {
    ...
    type ListPerformanceReviewsByEmployeeInput,
    type PerformanceServiceDependencies,
...
export class PerformanceService extends AbstractHrService {
    private readonly runtime: ServiceContext;
    ...
    getRepository(authorization: RepositoryAuthorizationContext): PerformanceRepository {
        return this.dependencies.repositoryFactory(authorization);
    }
...
export type { PerformanceServiceDependencies } from './performance-service.types';
