...
## OrgCentral Overrides
- Use React Query for async server state on the client.
- Use Zustand with persist/localStorage for client-local storage and preferences.
- Avoid React Context for shared server state except thin providers.
